...
<body>
    <header>
        <nav class="navbar navbar-dark bg-info navbar-expand-xl navbar fixed-top">
            ...
            <a class="navbar-brand text-white" href="/20192B106index.php">
            ...
            <button type="button" class="btn btn-dark navbar-toggler navbar-toggler-right" data-toggle="collapse" data-target="#navbarTogglerDemo01"
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <div class="navbar-nav mr-auto ml-auto text-center">
                    <a class="nav-link active" href="/20192B106/index.php">Inicio</a>
                    <!-- Submenu en collapse -->
                    ...
                    <a class="nav-link text-white" href="acerca_de.php">Nosotros</a>
