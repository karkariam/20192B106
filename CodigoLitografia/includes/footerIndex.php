    <footer>
        <div class="container-fluid bg-dark text-white">
            <div class="row">
                ...
                <!-- informacion gral -->
                <div class=" text-center col-sm-12 col-md-6 col-lg-4">
                    <strong>PBX:</strong> 6 42 98 10 <strong>|</strong> Diagonal
                    15 #45 - 178 CC. La rosita primer piso <strong>|</strong> Bucaramanga - Colombia <strong>|</strong>
                    www.litoangarita.com <strong>|</strong>
                    angaritaardilaimpresores@hotmail.com
                </div>
                <!-- botones redes sociales -->
                <div class="d-flex align-self-center justify-content-center col-sm-12 col-md-12 col-lg-4">
                    <div>
                        <a href="https://www.facebook.com/wilson.angaritasalazar" target="_blank" class="btn btn-outline-primary">FACEBOOK</a>
                        <a href="https://www.instagram.com/angaritaardilaimpresores95/" target="_blank" class="btn btn-outline-danger">INSTAGRAM</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="CodigoLitografia/js/bootstrap.bundle.js"></script>
    </body>
