<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Username = 'angaritaardilaimpresores@gmail.com'; //Modificar
		$mail->Password = 'mireya2012'; //Modificar
		
		$mail->setFrom('angaritaardilaimpresores@gmail.com', 'Confirmacion del Registro'); //Modificar
