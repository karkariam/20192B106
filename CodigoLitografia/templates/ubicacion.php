...
<div class="container">
    <div class="row">
        <div class="col-lg-6 col-sm-12">
            ...
            <p>
                En Angarita Ardila Impresores estamos comprometidos con su comodidad.
                Contamos con instalaciones mejoradas y adaptadas para brindarle la mejor atencion.
                Visitenos para tener el gusto de atenderle, estamos ubicados en: <br>
                <strong> Dirección:</strong> Diagonal 15 #45 - 178 CC. La rosita primer piso.
